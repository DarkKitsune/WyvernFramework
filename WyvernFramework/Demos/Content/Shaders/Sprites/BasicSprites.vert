...
layout (location = 0) in mat4 in_Instance;
...
void main()
{
    ...
    vec4 vPos = in_Instance * vec4(pos[index[gl_VertexIndex]], 0.0, 1.0);

    out_TexCoord = texCoord[index[gl_VertexIndex]];//in_InstanceRectangle.xy + in_InstanceRectangle.zw * texCoord[index[gl_VertexIndex]];
